...
var contactString = "<div class='social'><a href='mailto:work4anurag.tiwari@gmail.com'><div class='socialItem'><img class='socialItemI' src='gmail.png' alt='' style='width:50px;height:20px;'></div></a><a target='_blank' href='https://github.com/Danuragtiwari'><div class='socialItem'><img class='socialItemI' src='github.png' alt='' style='width:40px;height:40px;'></div></a><a href='https://www.linkedin.com/in/danurag23s/' target='_blank' rel='noopener noreferrer'><div class='socialItem'><img class='socialItemI' src='linkedin.png' alt='' style='width:40px;height:40px;'></div></a><a href='https://www.instagram.com/danurag23/' target='_blank' rel='noopener noreferrer'><div class='socialItem'><img class='socialItemI' src='download.jpg' alt='' style='width:40px;height:40px;'></div></a></div>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "new":
            ...
            break;
        case "profiles":
            sendTextMessage("You Can check my various coding profiles as below:<br><br><div class='social'><a target='_blank' href='https://github.com/Danuragtiwari'><div class='socialItem'><img src='github.png' alt='' style='width: 40px; height: 40px;'><label style='font-size: 14px; margin: auto;'>Github</label></div></a></div><br><br><div class='social'><a target='_blank' href='https://leetcode.com/Danurag/'><div class='socialItem'><img src='leetcode.png' alt='' style='width: 40px; height: 40px;'><label style='font-size: 14px; margin: auto;'>LeetCode</label></div></a></div><br><br><div class='social'><a target='_blank' href='https://auth.geeksforgeeks.org/user/danurag'><div class='socialItem'><img src='gfg.jpg' alt='' style='width: 40px; height: 40px;'><label style='font-size: 14px; margin: auto;'>GFG</label></div></a></div>");
        break;
        default:
            setTimeout(() => {
